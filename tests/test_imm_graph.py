...
from matchmaker.prob.imm_graph import IMMGraphFollower, estimate_chord_position
...
def _follower(part, onset=False, **kwargs):
    ...
    return IMMGraphFollower(reference_features=reference, score_positions=onsets, frame_rate=30, ref_frame_to_beat=beats,
